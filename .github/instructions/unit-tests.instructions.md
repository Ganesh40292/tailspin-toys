...
- Comments should explain test intent or a non-obvious fixture constraint, not restate the assertion.
- Use the repository TypeScript style: explicit types, two-space indentation, single quotes, semicolons, and trailing commas in multiline constructs.
